...
public class StatusAdapterDUClass extends RecyclerView.Adapter<StatusAdapterDUClass.ViewHolder> {
    String val = "";
    Context ctx;
    ArrayList<StatusModelUserClass> list;

    public StatusAdapterDUClass(String val, Context ctx, ArrayList<StatusModelUserClass> list) {
        this.val = val;
        this.ctx = ctx;
        this.list = list;
    }
